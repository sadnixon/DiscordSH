...
async function execute(message, args, user) {
  const embed = new EmbedBuilder().setTitle("Commands").addFields(
    ...
    },
    {
      name: `${PREFIX}join`,
      value:
        "After creating a game you can have players join it till it fills.",
    },
    {
      name: `${PREFIX}leave`,
      value: "After joining a game, if it has't filled yet, you can leave.",
    },
    {
      name: `${PREFIX}void`,
      value: "If enough players use this, the game will be voided (deleted).",
    },
    {
    ...
    },
    {
      ...
      value:
        "As president or chancellor during a Veto Zone government, you can choose to veto both possible policies if you both submit Ja.",
    },
    {
      name: `${PREFIX}powers`,
    ...
    },
    {
      ...
      value:
        "Shows you what other gamemodes of variant Secret Hitler are available on the bot.",
    },
    {
